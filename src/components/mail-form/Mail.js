      ...
      <>
         <div className="container mx-auto pb-10">
            <form action="" className="text-center">
               <h4 className="form__title font-normal text-xl text-black leading-7 mb-6">Be the first one to know when we launch our beta!</h4>
               ...
               <button className="form__button py-2 px-4 bg-orange-600 font-semibold text-base[20px] text-black hover:bg-black hover:text-white duration-700 rounded">Sign-up</button>
            </form>
         </div>
      </>
   );
